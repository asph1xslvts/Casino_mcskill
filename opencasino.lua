...
local function askWithdrawAmount()
    ...
    local function drawPrompt()
        ...
        centerText(by + 1, COLOR_TEXT, "Сколько вывести?")
        centerText(by + 2, COLOR_TEXT_DIM, "На балансе: " .. getBalance() .. " каз")
        centerText(by + 4, COLOR_MONEY, "> " .. entered .. "_")
        if warn then
            centerText(by + 5, COLOR_LOSE, warn)
        end
