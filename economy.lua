...
-- Vydacha: setInterfaceConfiguration + pushItem cherez ME Interface
...
local IFACE_SLOT = 1
local DB_SLOT    = 1
local PUSH_DIR   = "up"   -- strochnymi! sunduk stoit nad interfeysom
...
function economy.withdraw(count)
    ...
    -- 1. nastraivaem slot interfeysa na rovno "target" shtuk
